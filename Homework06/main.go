...
import (
	...
	"github.com/shidemere/2026-05-golang-basics/Homework06/model"
	"github.com/shidemere/2026-05-golang-basics/Homework06/service"
)
...
func main() {
	...
	err = service.HandleGameProcess(game, val)
	if err != nil {
